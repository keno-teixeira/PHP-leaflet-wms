...
L.drawLocal = {
	draw: {
		...
		handlers: {
			...
			marker: {
				tooltip: {
					start: 'Clique no mapa para colocar marcador.'
				}
			},
			polygon: {
				tooltip: {
					start: 'Clique para começar a desenhar forma.',
					cont: 'Clique para continuar a desenhar forma.',
					end: 'Clique primeiro ponto para fechar esta forma.'
				}
			},
			polyline: {
				error: '<strong>Erro:</strong> arestas da forma não podem se cruzar!',
				tooltip: {
					start: 'Clique para iniciar a linha de desenho.',
					cont: 'Clique para continuar linha de desenho.',
					end: 'Clique último ponto para terminar linha.'
				}
			},
			rectangle: {
				tooltip: {
	...
	edit: {
		...
		handlers: {
			edit: {
				tooltip: {
					text: 'Arraste alças, ou marcador para editar recursos.',
